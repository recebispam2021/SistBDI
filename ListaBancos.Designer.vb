...
Partial Class ListaBancos
    ...
    Private Sub InitializeComponent()
        ...
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "DataRegistro"
        ...
        'ColumnHeader4
        '
        Me.ColumnHeader4.Text = "Banco"
        Me.ColumnHeader4.Width = 130
        '
        'ColumnHeader5
        '
        Me.ColumnHeader5.Text = "Agencia"
        ...
        Me.Label1.Text = "Lista de Bancos Cadastrados no Sistema"
        ...
        'ColumnHeader6
        '
        Me.ColumnHeader6.Text = "Observação"
